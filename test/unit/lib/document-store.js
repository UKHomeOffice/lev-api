...
const tableMethodStub = sinon.stub();
const documentStore = proxyquire('../../../src/lib/document-store', {
  './table': () => ({
    read: tableMethodStub,
    search: tableMethodStub
  })
});

describe('lib/document-store/index.js', () => {
          ...
          describe('when called with one argument', () => {
            ...
            describe('that IS an integer', () => {
              ...
              describe('and the database fails', () => {
                ...
                before(() => {
                  tableMethodStub.returns(new Promise((resolve, reject) => reject(err)));
              ...
              describe('and the database returns nothing', () => {
                before(() => {
                  tableMethodStub.returns(new Promise(resolve => resolve(null)));
                  result2 = result.read(0);
                });
              ...
              describe('and the database returns a record', () => {
                ...
                before(() => {
                  tableMethodStub.returns(new Promise(resolve => resolve(record)));
                  result2 = result.read(0);
                });
          ...
          describe('when called with one argument', () => {
            ...
            describe('that IS an object', () => {
              ...
              describe('and the database returns a set of records', () => {
                ...
                before(() => {
                  tableMethodStub.returns(new Promise(resolve => resolve(docs.map(e => ({
                    data: e
                  })))));
                  result2 = result.search({});
                });
