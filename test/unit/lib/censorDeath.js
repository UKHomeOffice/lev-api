'use strict';
const redactDeath = require('../../../src/lib/censorDeath');
  ...
  describe('censorDeath function', () => {
    ...
    describe('record not blocked', () => {
      it('should return the full death data if role has full access', () => {
        expect(redactDeath(Object.assign({}, deathData), roleWithFullAccess))
    ...
    describe('record blocked', () => {
      it('should return null on relevant blocked record fields, with a role that has full access', () => {
        expect(redactDeath(Object.assign({}, deathDataBlockedRecord), roleWithFullAccess))
      ...
      it('should return null on relevant blocked record fields, with a role that does not have full access', () => {
        expect(redactDeath(Object.assign({}, deathDataBlockedRecord), roleWithoutFullAccess))
          .to.deep.equal(blockedDeathData);
      })
    })
  })
