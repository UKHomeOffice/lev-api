      ...
      describe('that IS a number', () => {
        ...
        describe('that IS an integer', () => {
          ...
          describe('that IS NOT negative', () => {
            ...
            it('increments the Prometheus counter lev_api_req', () => register.getSingleMetricAsString('lev_api_req').then(e => e.should.match(/[^0-9]1$/)));
            it('increments the Prometheus counter lev_api_req_birth', () => register.getSingleMetricAsString('lev_api_req_birth').then(e => e.should.match(/[^0-9]1$/)));
            it('increments the Prometheus counter lev_api_req_client', () => register.getSingleMetricAsString('lev_api_req_myclient').then(e => e.should.match(/[^0-9]1$/)));
            it('increments the Prometheus counter lev_api_req_group', () => register.getSingleMetricAsString('lev_api_req_group').then(e => e.should.match(/[^0-9]1$/)));
            it('increments the Prometheus counter lev_api_req_lookup', () => register.getSingleMetricAsString('lev_api_req_lookup').then(e => e.should.match(/[^0-9]1$/)));
            it('increments the Prometheus counter lev_api_req_birth_lookup', () => register.getSingleMetricAsString('lev_api_req_birth_lookup').then(e => e.should.match(/[^0-9]1$/)));
  ...
  describe('search()', () => {
    ...
    describe('when called with eight arguments', () => {
      ...
      describe('that IS an object', () => {
        ...
        it('increments the Prometheus counter lev_api_req_client', () => register.getSingleMetricAsString('lev_api_req_myclient').then(e => e.should.match(/[^0-9]1$/)));
        it('increments the Prometheus counter lev_api_req_group', () => register.getSingleMetricAsString('lev_api_req_group').then(e => e.should.match(/[^0-9]1$/)));
        it('increments the Prometheus counter lev_api_req_search', () => register.getSingleMetricAsString('lev_api_req_search').then(e => e.should.match(/[^0-9]1$/)));
        it('increments the Prometheus counter lev_api_req_birth_search', () => register.getSingleMetricAsString('lev_api_req_birth_search').then(e => e.should.match(/[^0-9]1$/)));
